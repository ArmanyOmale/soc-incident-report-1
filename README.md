...
### 4. Analysis
The repeated login attempts targeting multiple common account names (admin, root, guest, test) indicate automated credential guessing behavior. 
The consistent external IP address and short time intervals suggest a brute-force or scripted attack attempt.
...
### 6. Recommendations
1. Block the source IP address at firewall level.
2. Enable account lockout policies after multiple failed attempts.
3. Implement multi-factor authentication (MFA).
4. Review SSH configuration and disable root login.
5. Continue log monitoring for similar patterns.
